...
Route::post('/pizzas/{id}', 'App\Http\Controllers\PizzaController@update')->name('pizzas.update')->middleware('auth');
Auth::routes([
   "register" => false
]);
...
//Route::get('/pizzas', 'App\Http\Controllers\PizzaController@completed')->name('pizzas.completed')->middleware('auth');